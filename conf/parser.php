...
include_once('/var/www/radio/test/conf/channel.conf');
...
var $current = array();
    ...
    function parsefile() {
        ...
        for ($i=0; $i<$mcount; $i++) {
            ...
            foreach ($this->xml->source as $arr) {
                ...
                $this->stat[$mnt]['server_description'] = $arr->server_description;      		$this->stat[$mnt]['artist'] = $arr->artist;
	...
	require('/var/www/radio/test/conf/channel.conf');
