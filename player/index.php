	...
	<body>
		...
		<div class="preloader">
			<div class="text_area">
				...
				<span id="no-js-hide">{$LOADING-MESSAGE}<br><img src="assets/img/preloader.svg" width="48" height="48" alt="preloader"></span>
			</div>
		</div>
		...
		<div class="header">
			...
			<div class="logo"><a href="#" onclick="window.location.reload();"><img src="assets/img/logo.png" alt="Logo" width="auto" height="40"></a></div>

			<ul>
				<li class="settings" style="display: none;"><a href="#" title="{$UI-SETTINGS}"><img width="30" height="29" src="assets/img/settings.svg"></a>
					<ul class="streams-list"></ul>
				</li>
				<li class="channels" style="display: none;"><a href="#" title="{$UI-CHANNELS}"><img width="25" height="18" src="assets/img/channels.svg"></a>
